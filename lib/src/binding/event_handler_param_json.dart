...
class H265TranscoderObserverOnEnableTranscodeJson {
  ...
  @JsonKey(name: 'result')
  final H265TranscodeResult? result;

  factory H265TranscoderObserverOnEnableTranscodeJson.fromJson(
          Map<String, dynamic> json) =>
...
extension H265TranscoderObserverOnEnableTranscodeJsonBufferExt
    on H265TranscoderObserverOnEnableTranscodeJson {
  H265TranscoderObserverOnEnableTranscodeJson fillBuffers(
      List<Uint8List> bufferList) {
    if (bufferList.isEmpty) return this;
    return this;
  }
...
class H265TranscoderObserverOnQueryChannelJson {
  ...
  @JsonKey(name: 'originChannel')
  final String? originChannel;

  @JsonKey(name: 'transcodeChannel')
  final String? transcodeChannel;

  factory H265TranscoderObserverOnQueryChannelJson.fromJson(
          Map<String, dynamic> json) =>
...
extension H265TranscoderObserverOnQueryChannelJsonBufferExt
    on H265TranscoderObserverOnQueryChannelJson {
  H265TranscoderObserverOnQueryChannelJson fillBuffers(
      List<Uint8List> bufferList) {
    if (bufferList.isEmpty) return this;
    return this;
  }
...
class H265TranscoderObserverOnTriggerTranscodeJson {
  ...
  factory H265TranscoderObserverOnTriggerTranscodeJson.fromJson(
          Map<String, dynamic> json) =>
...
extension H265TranscoderObserverOnTriggerTranscodeJsonBufferExt
    on H265TranscoderObserverOnTriggerTranscodeJson {
  H265TranscoderObserverOnTriggerTranscodeJson fillBuffers(
      List<Uint8List> bufferList) {
    if (bufferList.isEmpty) return this;
    return this;
  }
